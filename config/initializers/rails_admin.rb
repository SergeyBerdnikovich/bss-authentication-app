# RailsAdmin config file. Generated on October 02, 2012 14:47
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Bss Authentication App', 'Admin']
  ...
  #     configure :role, :has_one_association 
  ...
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  #     configure :two_step_auth, :boolean 
